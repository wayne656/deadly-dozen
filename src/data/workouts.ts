...
export function exercisesFor(session: SessionId, week: number): ExerciseDef[] {
  ...
  return [
    {
      id: "run",
      name: "400m race-pace run",
      cue: "Track or treadmill. Hit the split, then go straight to the station.",
      restSec: 15,
      kind: "circuit",
      sets: 3,
      target: "3 rounds",
    ...
    {
      id: "lunge",
      name: "Overhead DB walking lunges",
      labour: "Labour 4",
      cue: "30 steps as 15 / 15s / 15.",
      restSec: 15,
      kind: "circuit",
      sets: 3,
      target: "30 steps",
    ...
    {
      id: "carry",
      name: "Plate / sandbag front carry",
      labour: "Labour 11",
      cue: "60m as 30 / 15s / 30. Rest 2 min after the round.",
      restSec: 120,
      kind: "circuit",
      sets: 3,
      target: "60m",
